...
function SuperDashboard() {
  ...
  useEffect(function() {
    ...
    const unsubAlerts = onSnapshot(
      query(collection(db, 'alerts'), orderBy('timestamp', 'desc'), limit(100)),
      function(snap) {
  ...
  // Attack type data is fetched from API (attackData state)

  // Per org traffic comparison data is loaded from backend analytics API
  ...
  return (
    <Layout>
      <TopBar title="Main Dashboard" showSearch={false} />
